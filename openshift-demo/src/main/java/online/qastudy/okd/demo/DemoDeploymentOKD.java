...
@Slf4j
public class DemoDeploymentOKD {
    ...
    public DemoDeploymentOKD(String namespace) {
    ...
    public DemoDeploymentOKD login() {
        ocClient = kubernetesClient.adapt(OpenShiftClient.class);
        return this;
    }

    public DemoDeploymentOKD createNewProject(String projectName, String displayName, String description) {
    ...
    public DemoDeploymentOKD deployPod() {
    ...
    public DemoDeploymentOKD deployService() {
    ...
    public DemoDeploymentOKD createRout() {
    ...
    public String getApplicationURL() {
        String applicationUrl = HTTP + ocClient.routes().list().getItems().stream()
